...
const Landing = () => {
  return (
    <div className="min-h-screen urban-pattern bg-background/50">
      ...
      {/* Hero Section with Beautiful Custom Background Image (Height reduced further) */}
      <section className="relative pt-16 pb-12 md:pt-20 md:pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            className="w-full h-full object-cover object-[85%_50%] opacity-100 dark:opacity-90"
          />
        ...
        <div className="container max-w-6xl relative z-20">
          <div className="flex flex-col items-center text-center space-y-12">
            <div className="inline-flex items-center gap-2 bg-primary/20 border border-primary/40 backdrop-blur-md rounded-full px-5 py-2 text-white text-xs font-black uppercase tracking-[0.2em] animate-in fade-in slide-in-from-bottom-4 duration-500">
