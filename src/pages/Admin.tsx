        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <Tabs defaultValue="moderation" className="space-y-6">
              ...
              <TabsContent value="admins" className="space-y-6 animate-in fade-<dyad-problem-report summary="14 problems">
<problem file="src/pages/Admin.tsx" line="230" column="17" code="1005">',' expected.</problem>
<problem file="src/pages/Admin.tsx" line="230" column="24" code="1005">',' expected.</problem>
<problem file="src/pages/Admin.tsx" line="230" column="51" code="1005">',' expected.</problem>
<problem file="src/pages/Admin.tsx" line="231" column="13" code="1005">',' expected.</problem>
<problem file="src/pages/Admin.tsx" line="937" column="22" code="1005">'}' expected.</problem>
<problem file="src/pages/Admin.tsx" line="196" column="13" code="2304">Cannot find name 'setStoreItemsLocally'.</problem>
<problem file="src/pages/Admin.tsx" line="220" column="7" code="2362">The left-hand side of an arithmetic operation must be of type 'any', 'number', 'bigint' or an enum type.</problem>
<problem file="src/pages/Admin.tsx" line="220" column="7" code="2322">Type 'number' is not assignable to type 'StoreItem'.</problem>
<problem file="src/pages/Admin.tsx" line="230" column="18" code="2304">Cannot find name 'write'.</problem>
<problem file="src/pages/Admin.tsx" line="230" column="24" code="2304">Cannot find name 'path'.</problem>
<problem file="src/pages/Admin.tsx" line="230" column="24" code="2322">Type 'string' is not assignable to type 'StoreItem'.</problem>
<problem file="src/pages/Admin.tsx" line="230" column="51" code="2304">Cannot find name 'description'.</problem>
<problem file="src/pages/Admin.tsx" line="230" column="51" code="2322">Type 'boolean' is not assignable to type 'StoreItem'.</problem>
<problem file="src/App.tsx" line="13" column="8" code="1192">Module '"C:/Users/Administrator/dyad-apps/Street Words/src/pages/Admin"' has no default export.</problem>
</dyad-problem-report><dyad-write path="src/pages/Admin.tsx" description="Complete rewrite of Admin page to remove broken partial tags and restore full compilation">
"use client";
